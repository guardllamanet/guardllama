...
type BlockedServicesApi interface {
	...
	@return BlockedServicesApiBlockedServicesAllRequest
	*/
	BlockedServicesAll(ctx context.Context) BlockedServicesApiBlockedServicesAllRequest

	// BlockedServicesAllExecute executes the request
	//  @return BlockedServicesAll
	BlockedServicesAllExecute(r BlockedServicesApiBlockedServicesAllRequest) (*BlockedServicesAll, *http.Response, error)
...
type BlockedServicesApiBlockedServicesAllRequest struct {
	ctx context.Context
	ApiService BlockedServicesApi
}

func (r BlockedServicesApiBlockedServicesAllRequest) Execute() (*BlockedServicesAll, *http.Response, error) {
...
BlockedServicesAll Get available services to use for blocking
 ...
 @return BlockedServicesApiBlockedServicesAllRequest
*/
func (a *BlockedServicesApiService) BlockedServicesAll(ctx context.Context) BlockedServicesApiBlockedServicesAllRequest {
	return BlockedServicesApiBlockedServicesAllRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return BlockedServicesAll
func (a *BlockedServicesApiService) BlockedServicesAllExecute(r BlockedServicesApiBlockedServicesAllRequest) (*BlockedServicesAll, *http.Response, error) {
	var (
