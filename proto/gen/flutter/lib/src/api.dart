...
import 'package:guardllama_api/src/serializers.dart';
import 'package:guardllama_api/src/auth/api_key_auth.dart';
...
class GuardllamaApi {
  ...
  /// by doing that all interceptors will not be executed
  ServerServiceApi getServerServiceApi() {
    return ServerServiceApi(dio, serializers);
  }

  /// Get TunnelServiceApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  TunnelServiceApi getTunnelServiceApi() {
    return TunnelServiceApi(dio, serializers);
  }

  /// Get WireGuardServiceApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  WireGuardServiceApi getWireGuardServiceApi() {
    return WireGuardServiceApi(dio, serializers);
  }
}
