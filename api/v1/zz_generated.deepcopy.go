...
func (in *AdGuardSpec) DeepCopyInto(out *AdGuardSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AdGuardSpec.
func (in *AdGuardSpec) DeepCopy() *AdGuardSpec {
	if in == nil {
		return nil
	}
	out := new(AdGuardSpec)
